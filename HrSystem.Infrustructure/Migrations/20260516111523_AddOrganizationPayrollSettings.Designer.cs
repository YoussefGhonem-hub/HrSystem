...
namespace HrSystem.Infrustructure.Migrations
{
    ...
    [Migration("20260516111523_AddOrganizationPayrollSettings")]
    partial class AddOrganizationPayrollSettings
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("HrSystem.Domain.Entities.Attendance.Attendance", b =>
                {
                    ...
                    b.Property<Guid?>("CheckInPointId")
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.Property<Guid?>("CheckOutPointId")
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("HrSystem.Domain.Entities.Attendance.BranchAttendanceSetting", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");

                    b.Property<bool>("AllowExcelImport")
                        .HasColumnType("bit");

                    b.Property<bool>("AllowFaceId")
                        .HasColumnType("bit");

                    b.Property<bool>("AllowFingerprint")
                        .HasColumnType("bit");
                    ...
                    b.Property<bool>("AllowMultipleCheckInsPerDay")
                        .HasColumnType("bit");
                    ...
                    b.Property<string>("ExcelDateFormat")
                        .HasMaxLength(50)
                        .HasColumnType("nvarchar(50)");

                    b.Property<bool>("ExcelImportSkipDuplicates")
                        .HasColumnType("bit");

                    b.Property<double>("FaceIdConfidenceThreshold")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("float")
                        .HasDefaultValue(0.84999999999999998);

                    b.Property<bool>("FaceIdRequireLiveness")
                        .HasColumnType("bit");

                    b.Property<bool>("IsDeleted")
                        .HasColumnType("bit");

                    b.Property<int>("MinCheckInDurationMinutes")
                        .HasColumnType("int");
                    ...
                    b.ToTable("BranchAttendanceSettings", "Attendance");
                });

            modelBuilder.Entity("HrSystem.Domain.Entities.Attendance.BranchCheckInPoint", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.Property<Guid>("BranchAttendanceSettingId")
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.Property<bool>("IsCheckInPoint")
                        .HasColumnType("bit");

                    b.Property<bool>("IsCheckOutPoint")
                        .HasColumnType("bit");
                    ...
                    b.HasIndex("BranchAttendanceSettingId");

                    b.HasIndex("BranchId");

                    b.HasIndex("IsDeleted");

                    b.ToTable("BranchCheckInPoints", "Attendance");
                });
            ...
            modelBuilder.Entity("HrSystem.Domain.Entities.Leave.EmployeeLeaveBalance", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("HrSystem.Domain.Entities.Leave.EmployeeLeaveTransaction", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.ToTable("EmployeeLeaveTransactions", "Leave");
                });
            ...
            modelBuilder.Entity("HrSystem.Domain.Entities.Organization.BranchWorkSchedule", b =>
                {
                    ...
                    b.Property<decimal>("AbsentThresholdHours")
                    ...
                    b.Property<bool>("IsBreakTimeDeducted")
                        .HasColumnType("bit");
                    ...
                    b.Property<decimal>("MinimumFullDayHours")
                        .HasColumnType("decimal(5,2)");

                    b.Property<decimal>("MinimumHalfDayHours")
                        .HasColumnType("decimal(5,2)");
                    ...
                    b.Property<decimal>("OvertimeStartsAfterHours")
                        .HasColumnType("decimal(5,2)");

                    b.Property<decimal>("ShiftTotalHours")
                        .HasColumnType("decimal(5,2)");
            ...
            modelBuilder.Entity("HrSystem.Domain.Entities.Organization.OrganizationPayrollSettings", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.Property<int?>("CustomCutoffEndDay")
                        .HasColumnType("int");

                    b.Property<int?>("CustomCutoffStartDay")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("HrSystem.Domain.Entities.Payroll.BankExportProfile", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.ToTable("BankExportProfiles", "Payroll");
                });
            ...
            modelBuilder.Entity("HrSystem.Domain.Entities.Requests.AttendanceCorrectionType", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.ToTable("AttendanceCorrectionTypes", "Requests");
                });
            ...
            modelBuilder.Entity("HrSystem.Domain.Entities.Requests.EmployeeGlobalPermissionLimit", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.Property<decimal?>("TotalMonthlyHours")
                        .HasColumnType("decimal(18,2)");
                    ...
                    b.ToTable("EmployeeGlobalPermissionLimits");
                });

            modelBuilder.Entity("HrSystem.Domain.Entities.Requests.EmployeePermissionLimit", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.ToTable("EmployeePermissionLimits", "Requests");
                });
            ...
            modelBuilder.Entity("HrSystem.Domain.Entities.Requests.EmployeeVacationLimit", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.HasIndex("EmployeeId", "VacationTypeId")
                        .IsUnique();

                    b.ToTable("EmployeeVacationLimits", "Requests");
                });
            ...
            modelBuilder.Entity("HrSystem.Domain.Entities.Requests.PermissionType", b =>
                {
                    ...
                    b.Property<decimal?>("DefaultMonthlyHours")
                        .HasColumnType("decimal(18,2)");
            ...
            modelBuilder.Entity("HrSystem.Domain.Entities.Attendance.Attendance", b =>
                {
                    b.HasOne("HrSystem.Domain.Entities.Attendance.BranchCheckInPoint", "CheckInPoint")
                        .WithMany()
                        .HasForeignKey("CheckInPointId")
                        .OnDelete(DeleteBehavior.SetNull);

                    b.HasOne("HrSystem.Domain.Entities.Attendance.BranchCheckInPoint", "CheckOutPoint")
                        .WithMany()
                        .HasForeignKey("CheckOutPointId")
            ...
            modelBuilder.Entity("HrSystem.Domain.Entities.Attendance.BranchAttendanceSetting", b =>
                {
                    b.HasOne("HrSystem.Domain.Entities.Organization.Branch", "Branch")
                        ...
                        .HasForeignKey("HrSystem.Domain.Entities.Attendance.BranchAttendanceSetting", "BranchId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("HrSystem.Domain.Entities.Attendance.BranchCheckInPoint", b =>
                {
                    b.HasOne("HrSystem.Domain.Entities.Attendance.BranchAttendanceSetting", "BranchAttendanceSetting")
                        .WithMany("CheckInPoints")
                        .HasForeignKey("BranchAttendanceSettingId")
                        .OnDelete(DeleteBehavior.NoAction)
                        .IsRequired();
                    ...
                    b.Navigation("BranchAttendanceSetting");
                });
            ...
            modelBuilder.Entity("HrSystem.Domain.Entities.Leave.EmployeeLeaveTransaction", b =>
                {
                    b.HasOne("HrSystem.Domain.Entities.Leave.EmployeeLeaveBalance", "LeaveBalance")
            ...
            modelBuilder.Entity("HrSystem.Domain.Entities.Payroll.PayslipDeduction", b =>
                {
                    b.HasOne("HrSystem.Domain.Entities.Payroll.Loan", "Loan")
                        .WithMany()
