...
public class CreateOffboardingTaskCommandValidator : AbstractValidator<CreateOffboardingTaskCommand>
{
    private readonly ApplicationDbContext _context;

    public CreateOffboardingTaskCommandValidator(ApplicationDbContext context)
    {
        _context = context;
