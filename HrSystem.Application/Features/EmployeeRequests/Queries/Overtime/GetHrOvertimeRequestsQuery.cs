...
public class GetHrOvertimeRequestsQueryHandler : IRequestHandler<GetHrOvertimeRequestsQuery, ErrorOr<GenericResponse<PagedResult<OvertimeRequestListDto>>>>
{
    private readonly ApplicationDbContext _context;

    public GetHrOvertimeRequestsQueryHandler(ApplicationDbContext context)
    {
        _context = context;
    }
