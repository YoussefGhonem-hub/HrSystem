...
public class GetOvertimeRequestByIdQueryHandler : IRequestHandler<GetOvertimeRequestByIdQuery, ErrorOr<GenericResponse<EmployeeRequestDto>>>
{
    private readonly ApplicationDbContext _context;

    public GetOvertimeRequestByIdQueryHandler(ApplicationDbContext context)
    {
        _context = context;
    }
        ...
        CancellationToken cancellationToken)
    {
        var employeeRequest = await _context.EmployeeRequests
            ...
            .FirstOrDefaultAsync(r => r.Id == request.Id && r.RequestTypeRef != null && r.RequestTypeRef.Code == "OverTime", cancellationToken);
