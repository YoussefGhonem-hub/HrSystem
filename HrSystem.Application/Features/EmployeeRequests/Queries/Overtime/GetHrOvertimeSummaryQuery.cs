...
public class GetHrOvertimeSummaryQueryHandler : IRequestHandler<GetHrOvertimeSummaryQuery, ErrorOr<GenericResponse<HrOvertimeSummaryDto>>>
{
    private readonly ApplicationDbContext _context;

    public GetHrOvertimeSummaryQueryHandler(ApplicationDbContext context)
    {
        _context = context;
    }
        ...
        CancellationToken cancellationToken)
    {
        ...
        var summary = new HrOvertimeSummaryDto
        {
            ...
            TotalPlannedHours = requests.Where(r => r.OvertimeDetail != null).Sum(r => r.OvertimeDetail!.PlannedHours.TotalHours),
            TotalActualHours = requests.Where(r => r.OvertimeDetail?.ActualHours != null && r.Status == EmployeeRequestStatus.Approved).Sum(r => r.OvertimeDetail!.ActualHours!.Value.TotalHours)
        };
