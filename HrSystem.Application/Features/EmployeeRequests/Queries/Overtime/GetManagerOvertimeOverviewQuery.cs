...
public class GetManagerOvertimeOverviewQueryHandler
    : IRequestHandler<GetManagerOvertimeOverviewQuery, ErrorOr<GenericResponse<ManagerOvertimeOverviewDto>>>
{
    private readonly ApplicationDbContext _context;

    public GetManagerOvertimeOverviewQueryHandler(ApplicationDbContext context) => _context = context;
    ...
    private static OvertimeRequestListDto MapToDto(Domain.Entities.Requests.EmployeeRequest r) => new()
    {
        Id = r.Id,
