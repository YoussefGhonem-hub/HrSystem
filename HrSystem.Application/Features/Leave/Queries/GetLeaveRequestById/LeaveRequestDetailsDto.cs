...
public class LeaveRequestDetailsDto
{
    ...
    public string? HRApprovedByNameAr { get; set; }
    ...
    public static string? GetFileName(string? documentUrl, string? documentPath)
    {
        var source = !string.IsNullOrWhiteSpace(documentPath)
            ? documentPath
            : documentUrl;
